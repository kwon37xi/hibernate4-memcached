...
abstract class BaseRegionAccessStrategy implements RegionAccessStrategy {
	 ...
	 *
	 * @see org.hibernate.cache.spi.access.EntityRegionAccessStrategy#remove(Object)
	 * @see org.hibernate.cache.spi.access.CollectionRegionAccessStrategy#remove(Object)
	 */
	@Override
	public void remove(Object key) throws CacheException {
	}
		/**
	 * Called to evictAll data from the entire region
	 *
